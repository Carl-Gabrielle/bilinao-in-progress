        ...
        <div class="hidden z-10 sm:block fixed top-0 left-0 h-screen w-80 bg-white overflow-y-auto">
            <div class="px-6 py-6">
                ...
                <nav class="mt-11">
                    ...
                    <a id="productToggle" href="#" class="flex items-center gap-2 px-6 py-3 text-sm hover:bg-gray-100  rounded-3xl">
...
<script>
    $(document).ready(function() {
        $('#productToggle').click(function(event) {
