{{-- @include('layout') --}}
            ...
            <div class="flex justify-between items-center h-16 sm:px-6 px-0 ">
                ...
                <div class="hidden md:none lg:block">
                    <div class="flex items-center space-x-4">
                        <a href="{{route('dashboard.user_dashboard')}}" class=" text-gray-800 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-bold">Home</a>
                        <a href="#" class="text-gray-800 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-bold">About Us</a>
                        <a href="#" class="text-gray-800 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-bold">Shop</a>
                        <a id="category_menu" class="flex items-center text-gray-800 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-bold cursor-pointer" >Category
    ...
    <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
        ...
        <div id="mobile-menu" class="mobile-menu md:hidden absolute left-1/2 transform -translate-x-1/2 z-10 mt-2 w-80 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1" style="display: none;">
